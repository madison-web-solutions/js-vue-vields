...
import type { Path, FormValue, MessageBag, EditMode, ChoicesProvider, LinksProvider, MediaProvider, UploadProvider, UploadedFileCache, PasswordStrengthProvider, Config } from "../types";
...
const symbols = {
  ...
  parentValue: Symbol('vfm-parent-value') as InjectionKey<Ref<FormValue> | undefined>,
  parentErrors: Symbol('vfm-parent-errors') as InjectionKey<Ref<MessageBag> | undefined>,
