  ...
  <FieldWrapper v-bind="standardWrapperProps">
    <template #input>
      <div
        v-pclass="{
          'repeater-table': true,
          'has-index-col': hasIndexCol,
          'has-control-col': editable,
        }"
        :style="repeaterStyle"
      >
        ...
        <FieldArrayItem v-for="item in loopItems" :index="item.index">
          ...
          >
            <div
              v-if="hasIndexCol"
              v-pclass="'repeater-table-cell repeater-table-item-index'"
            >
            ...
            <FieldGroup>
              <div
                v-for="col in cols"
                v-pclass="'repeater-table-cell repeater-table-item-content'"
              >
                <slot
                  :name="col.name"
                  :index="item.index"
            ...
            <div
              v-if="editable"
              v-pclass="'repeater-table-cell repeater-table-item-control'"
            >
              <button
                v-if="canAddRow"
            ...
            <div
              v-if="item.showRowErrors"
              v-pclass="'repeater-table-cell repeater-table-item-errors'"
            >
            ...
            <template v-if="editable && isMoving">
              <div
                v-pclass="'repeater-table-move-target move-before'"
                @click="item.completeMoveBefore"
              ></div>
              <div
                v-pclass="'repeater-table-move-target move-after'"
