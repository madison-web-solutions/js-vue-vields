<template>
    <div>
        <div class="row g-3 mb-3">
            <SelectField label="Slide Type" name="slide_type" :choices="slideTypeChoices" :required="true" class="col-md" />
        </div>
...
import { TextAreaField, SelectField, HtmlField, TextField, getCurrentValue } from 'vue-fields-ms';
